class CarrotMarketNeighborhoodLife {
...
String carrotMarketLifeTitle = '이웃과 함께 만드는 봄 간식 지도 마음까지 따듯해지는 봄 간식을 만나보세요.';

// 샘플 데이터 2
List<CarrotMarketNeighborhoodLife> carrotMarketNeighborhoodLifeList = [
  CarrotMarketNeighborhoodLife(
    category: '우리동네질문',
