class CarrotMarketRecommendStore {
  String storeName;
  String location;
  String description;
  int commentCount;
...
final List carrotMarketSearchKeyword = ['인테리어', '학원', '이사', '카페', '용달', '네일', '에어콘'];

List<CarrotMarketRecommendStore> carrotMarketRecommendStoreList = [
  CarrotMarketRecommendStore(
      storeName: '네일가게',
      location: '좌동',
